...
},{"../../collections/commits.js":3,"./templates/list.jade":2,"backbone":6,"components-jquery":9,"sharify":11}],2:[function(require,module,exports){
var jade = require('jade/lib/runtime.js');module.exports = function anonymous(locals) {
var buf = [];
var locals_ = (locals || {}),commits = locals_.commits;// iterate commits
;(function(){
  var $$obj = commits;
...
buf.push("<li>" + (jade.escape(null == (jade.interp = commit.get('commit').message) ? "" : jade.interp)) + "</li>");
    }
...
},{"jade/lib/runtime.js":10}],3:[function(require,module,exports){
var Backbone = require('backbone')
  , sd = require('sharify').data
...
},{"../models/commit":5,"backbone":6,"sharify":11}],4:[function(require,module,exports){
$(require('../../apps/commits/client.js').init)
},{"../../apps/commits/client.js":1}],5:[function(require,module,exports){
var Backbone = require('backbone')
  , sd = require('sharify').data;
